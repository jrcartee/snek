...
var _user$project$Types$Model = F4(
	function (a, b, c, d) {
		return {state: a, player: b, food: c, mdl: d};
	});
...
var _user$project$Types$Player = F5(
	function (a, b, c, d, e) {
		return {isGrowing: a, head: b, dir: c, score: d, body: e};
	});
var _user$project$Types$FoodItem = function (a) {
	return {pos: a};
};
var _user$project$Types$Failed = {ctor: 'Failed'};
var _user$project$Types$Paused = {ctor: 'Paused'};
...
var _user$project$Types$NewFood = function (a) {
...
var _user$project$Types$ArrowDown = {ctor: 'ArrowDown'};
var _user$project$Types$ArrowUp = {ctor: 'ArrowUp'};
var _user$project$Types$ArrowRight = {ctor: 'ArrowRight'};
var _user$project$Types$ArrowLeft = {ctor: 'ArrowLeft'};
var _user$project$Types$Space = {ctor: 'Space'};
var _user$project$Types$keyFromKeyCode = function (keyCode) {
	var _p0 = keyCode;
	switch (_p0) {
		case 32:
			return _user$project$Types$Space;
		case 37:
			return _user$project$Types$ArrowLeft;
		case 38:
			return _user$project$Types$ArrowUp;
		case 39:
			return _user$project$Types$ArrowRight;
		case 40:
			return _user$project$Types$ArrowDown;
		default:
			return _user$project$Types$Unknown;
	}
};
var _user$project$Types$downsToMsg = function (kc) {
	return _user$project$Types$KeyDown(
		_user$project$Types$keyFromKeyCode(kc));
};
var _user$project$Types$BodyNode = F2(
	function (a, b) {
		return {ctor: 'BodyNode', _0: a, _1: b};
	});
...
var _user$project$Board$tupleToPosition = function (_p0) {
	var _p1 = _p0;
	return {x: _p1._0 * _user$project$Board$conf.incr, y: _p1._1 * _user$project$Board$conf.incr};
};
var _user$project$Board$positionGenerator = function () {
	var mapFn = _user$project$Board$tupleToPosition;
	var h = _user$project$Board$conf.height;
	var w = _user$project$Board$conf.width;
	var i = _user$project$Board$conf.incr;
	return A2(
		_elm_lang$core$Random$map,
		mapFn,
		_elm_lang$core$Random$pair(
			A2(_elm_lang$core$Random$int, 0, ((w - i) / i) | 0))(
			A2(_elm_lang$core$Random$int, 0, ((h - i) / i) | 0)));
}();
var _user$project$Board$adjustPosition = function (pos) {
	var i = _user$project$Board$conf.incr;
	var h = _user$project$Board$conf.height;
	var w = _user$project$Board$conf.width;
	var dy = pos.y;
	var dx = pos.x;
	return (_elm_lang$core$Native_Utils.cmp(pos.x, w) > 0) ? _elm_lang$core$Native_Utils.update(
		pos,
		{x: dx - (w + i)}) : ((_elm_lang$core$Native_Utils.cmp(pos.x, 0) < 0) ? _elm_lang$core$Native_Utils.update(
		pos,
		{x: dx + w}) : ((_elm_lang$core$Native_Utils.cmp(pos.y, h) > 0) ? _elm_lang$core$Native_Utils.update(
		pos,
		{y: dy - (h + i)}) : ((_elm_lang$core$Native_Utils.cmp(pos.y, 0) < 0) ? _elm_lang$core$Native_Utils.update(
		pos,
		{y: dy + h}) : pos)));
};
var _user$project$Board$incrPostion = F2(
	function (pos, dir) {
		var _p2 = dir;
		switch (_p2.ctor) {
			case 'North':
				return _user$project$Board$adjustPosition(
					_elm_lang$core$Native_Utils.update(
						pos,
						{y: pos.y - _user$project$Board$conf.incr}));
			case 'South':
				return _user$project$Board$adjustPosition(
					_elm_lang$core$Native_Utils.update(
						pos,
			...
			case 'West':
				return _user$project$Board$adjustPosition(
					_elm_lang$core$Native_Utils.update(
						pos,
						{x: pos.x - _user$project$Board$conf.incr}));
			default:
				return _user$project$Board$adjustPosition(
					_elm_lang$core$Native_Utils.update(
						pos,
...
var _user$project$Board$viewPosition = F2(
	function (color, pos) {
		return A2(
				...
				_1: {
					...
					_1: {
						...
						_0: _elm_lang$svg$Svg_Attributes$width(
							_elm_lang$core$Basics$toString(_user$project$Board$conf.incr)),
						_1: {
							ctor: '::',
...
var _user$project$Board$viewX = function (x) {
	var d = _elm_lang$core$Basics$toString(x * _user$project$Board$conf.incr);
	return A2(
		_elm_lang$svg$Svg$line,
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$x1(d),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$y1('0'),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$x2(d),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$y2('500'),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$stroke('#023963'),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$strokeWidth('0.1px'),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$Board$viewY = function (y) {
	var d = _elm_lang$core$Basics$toString(y * _user$project$Board$conf.incr);
	return A2(
		_elm_lang$svg$Svg$line,
		{
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$y1(d),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$x2('500'),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$y2(d),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$stroke('#023963'),
							_1: {
...
var _user$project$Board$viewGrid = function () {
	var rangeY = A2(_elm_lang$core$List$range, 0, _user$project$Board$conf.height);
	var rangeX = A2(_elm_lang$core$List$range, 0, _user$project$Board$conf.width);
	return A2(
		_elm_lang$core$List$append,
		A2(_elm_lang$core$List$map, _user$project$Board$viewX, rangeX),
		A2(_elm_lang$core$List$map, _user$project$Board$viewY, rangeY));
}();
var _user$project$Board$boxDimensions = A2(
	_elm_lang$core$Basics_ops['++'],
	'0 0 ',
	A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(_user$project$Board$conf.width),
		A2(
			_elm_lang$core$Basics_ops['++'],
			' ',
			_elm_lang$core$Basics$toString(_user$project$Board$conf.height))));
var _user$project$Board$viewBoard = function (children) {
	return A2(
		_elm_lang$svg$Svg$svg,
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$viewBox(_user$project$Board$boxDimensions),
			_1: {
				ctor: '::',
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$display('inline-block'),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Effects$keyStream = _elm_lang$keyboard$Keyboard$downs(_user$project$Types$downsToMsg);
var _user$project$Effects$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Effects$tickStream,
			_1: {
				ctor: '::',
				_0: _user$project$Effects$keyStream,
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Effects$randFoodItem = A2(
	_elm_lang$core$Random$map,
	function (pos) {
		return {pos: pos};
	},
	_user$project$Board$positionGenerator);
var _user$project$Effects$generateFood = A2(
	_elm_lang$core$Random$generate,
...
var _user$project$View$viewFood = function (list) {
	return A2(_elm_lang$core$List$map, _user$project$View$viewFoodPixel, list);
};
var _user$project$View$viewSnakePixel = _user$project$Board$viewPosition('red');
var _user$project$View$viewSnakeBody = function (body) {
	var _p0 = body;
	if (_p0.ctor === 'BodyNode') {
		return {
			ctor: '::',
			_0: _user$project$View$viewSnakePixel(_p0._0),
			_1: _user$project$View$viewSnakeBody(_p0._1)
		};
	} else {
		return {
			ctor: '::',
...
var _user$project$View$viewSnake = function (player) {
	return {
		ctor: '::',
		_0: _user$project$View$viewSnakePixel(player.head),
		_1: _user$project$View$viewSnakeBody(player.body)
	};
};
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Board$viewBoard(
						_elm_lang$core$List$concat(
							{
								ctor: '::',
								_0: _user$project$View$viewSnake(model.player),
								_1: {
									ctor: '::',
									_0: _user$project$View$viewFood(model.food),
									_1: {ctor: '[]'}
								}
							})),
					_1: {ctor: '[]'}
...
var _user$project$View$viewHeader = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('Snek'),
		_1: {ctor: '[]'}
	});
var _user$project$View$view = function (model) {
	return A3(
		...
		_MichaelCombs28$elm_mdl$Material_Color$LightGreen,
		A4(
...
var _user$project$Update$keyWhenFailed = F2(
	function (model, key) {
		var _p0 = key;
		if (_p0.ctor === 'Space') {
			return _user$project$Model$init;
		} else {
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _user$project$Update$bodyPosMatchesHead = F2(
	function (model, body) {
		var _p1 = body;
		if (_p1.ctor === 'Empty') {
			return false;
		} else {
			return _elm_lang$core$Native_Utils.eq(model.player.head, _p1._0) || A2(_user$project$Update$bodyPosMatchesHead, model, _p1._1);
		}
	});
var _user$project$Update$checkForFail = function (model) {
	return A2(_user$project$Update$bodyPosMatchesHead, model, model.player.body) ? _elm_lang$core$Native_Utils.update(
		model,
		{state: _user$project$Types$Failed}) : model;
};
var _user$project$Update$togglePause = function (model) {
	return _elm_lang$core$Native_Utils.eq(model.state, _user$project$Types$Paused) ? _elm_lang$core$Native_Utils.update(
		model,
		{state: _user$project$Types$Running}) : (_elm_lang$core$Native_Utils.eq(model.state, _user$project$Types$Running) ? _elm_lang$core$Native_Utils.update(
		model,
		{state: _user$project$Types$Paused}) : model);
};
var _user$project$Update$keyWhenPaused = F2(
	function (model, key) {
		var _p2 = key;
		if (_p2.ctor === 'Space') {
			return _user$project$Update$togglePause(model);
		} else {
			return model;
		}
	});
var _user$project$Update$keyWhenRunning = F2(
	function (model, key) {
		var p = model.player;
		var _p3 = key;
		switch (_p3.ctor) {
...
var _user$project$Update$removeFood = F2(
	function (food, pos) {
		return A2(
			_elm_lang$core$List$filter,
			function (i) {
				return !_elm_lang$core$Native_Utils.eq(pos, i.pos);
			},
			food);
	});
var _user$project$Update$foodToEat = function (m) {
	return A2(
		_elm_lang$core$List$any,
		function (i) {
			return _elm_lang$core$Native_Utils.eq(m.player.head, i.pos);
		},
		m.food);
};
var _user$project$Update$foodEaten = function (p) {
	var s = p.score;
	return _elm_lang$core$Native_Utils.update(
		p,
		{score: s + 1, isGrowing: true});
};
var _user$project$Update$eatFood = function (model) {
	var p = model.player;
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			player: _user$project$Update$foodEaten(p),
			food: A2(_user$project$Update$removeFood, model.food, p.head)
		});
};
var _user$project$Update$updateFood = function (model) {
	return _user$project$Update$foodToEat(model) ? {
		ctor: '_Tuple2',
		_0: _user$project$Update$eatFood(model),
		_1: _elm_lang$core$Platform_Cmd$none
	} : (_elm_lang$core$List$isEmpty(model.food) ? {ctor: '_Tuple2', _0: model, _1: _user$project$Effects$generateFood} : {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
};
var _user$project$Update$updateBody = F3(
	function (grow, pos, body) {
		var _p4 = body;
		if (_p4.ctor === 'Empty') {
			return grow ? A2(_user$project$Types$BodyNode, pos, _user$project$Types$Empty) : _user$project$Types$Empty;
		} else {
			return A2(
				_user$project$Types$BodyNode,
				pos,
				A3(_user$project$Update$updateBody, grow, _p4._0, _p4._1));
		}
	});
var _user$project$Update$advancePlayer = function (model) {
	var p = model.player;
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			player: _elm_lang$core$Native_Utils.update(
				p,
				{
					head: A2(_user$project$Board$incrPostion, p.head, p.dir),
					body: A3(_user$project$Update$updateBody, p.isGrowing, p.head, p.body),
					isGrowing: false
				})
		});
};
var _user$project$Update$onTick = function (model) {
	var _p5 = model.state;
	if (_p5.ctor === 'Running') {
		return _user$project$Update$updateFood(
			_user$project$Update$checkForFail(
				_user$project$Update$advancePlayer(model)));
	} else {
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	}
};
var _user$project$Update$onKeyDown = F2(
	function (model, key) {
		var _p6 = model.state;
		switch (_p6.ctor) {
			case 'Paused':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Update$keyWhenPaused, model, key),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Running':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Update$keyWhenRunning, model, key),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return A2(_user$project$Update$keyWhenFailed, model, key);
		}
	});
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p7.ctor) {
			case 'KeyDown':
				return A2(_user$project$Update$onKeyDown, model, _p7._0);
			case 'Tick':
				return _user$project$Update$onTick(model);
			case 'NewFood':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
